...
<!-- Sparkline -->
<script src="{{ asset('vendor/LaraAdminLTE/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}"></script>
<!-- page script -->
<script src="{{ asset('vendor/LaraAdminLTE/js/inlinejs.js') }}"></script>
@endsection
