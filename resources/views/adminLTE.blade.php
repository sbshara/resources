...
<section class="col-lg-7 connectedSortable">
        ...
        <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                    <img src="img/people/user4-128x128.jpg" alt="user image" class="online">
                    <p class="message">
                        <a href="#" class="name">
                ...
                <!-- chat item -->
                <div class="item">
                    <img src="img/people/user3-128x128.jpg" alt="user image" class="offline">
                    <p class="message">
                        <a href="#" class="name">
                            <small class="text-muted pull-right">
                                <i class="fa fa-clock-o"></i> 5:15
                            </small> Alexander Pierce
                        </a>I would like to meet you to discuss the latest news about the arrival of the new theme. They say it is going to be one the best themes on the market
                    </p>
                </div>
                <!-- /.item -->
                <!-- chat item -->
                <div class="item">
                    <img src="img/people/user2-160x160.jpg" alt="user image" class="offline">
                    <p class="message">
                        <a href="#" class="name">
                            <small class="text-muted pull-right">
